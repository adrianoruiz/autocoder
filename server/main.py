...
from .services.add_features_session import cleanup_all_add_features_sessions
...
async def lifespan(app: FastAPI):
    ...
    await cleanup_all_add_features_sessions()
...
app.include_router(add_features_router)
